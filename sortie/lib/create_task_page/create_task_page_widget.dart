...
class _CreateTaskPageWidgetState extends State<CreateTaskPageWidget> {
  ...
  saveDate() {
    ToDoModel toDoModel = ToDoModel(
      ...
      toDoDate: Timestamp.fromDate(datePicked),
      toDoDescription: textController2.text,
      toDoName: textController1.text,
      toDoStatus: false,
    );

    ToDoService().saveToDo(toDoModel).then((value) {
      if (value == "success") {
        Fluttertoast.showToast(msg: "Hurray! Added Successfully.");
        Get.find<MyController>().allToDos.add(toDoModel);
        Get.back();
      } else {
